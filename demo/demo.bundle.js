...
function SwiperContainerDirective($timeout) {
    ...
    return {
        ...
        link: function link($scope, $element, $attr, $ctrl) {
            ...
            var classWatcher = $attr.$observe('class', function () {
...
var _appController = __webpack_require__(49);
...
angular.module('AppModule', [_swiper.moduleName]).controller(_appController.controllerName, _appController.AppController);
...
var AppController =
/* @ngInject */
exports.AppController = function AppController() {
    _classCallCheck(this, AppController);

    this.items = [{ id: 1 }, { id: 31 }, { id: 21 }, { id: 11 }];
};
